            ...
            <?php if ( have_posts() ) : ?>
                ...
                if ( 1 === $paged ) : ?>
                    <div class="featured-post-wrapper mb-5 pb-5">
                        <?php
                        // Display the latest post as featured (already handled by main query offset for the list,
                        // but we fetch it separately here for the big display)
