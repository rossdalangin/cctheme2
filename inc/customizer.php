...
function closeclient_customize_register( $wp_customize ) {
    ...
    $labels = array(
        ...
        'closeclient_assets_headline' => 'Strategic Assets: Headline',
        'closeclient_assets_desc' => 'Strategic Assets: Description',
        'closeclient_label_portfolio_item_tag' => 'Portfolio Card: Tag Label',
        'closeclient_label_portfolio_item_btn' => 'Portfolio Card: Button Text',
        'closeclient_label_service_item_btn' => 'Service Card: Button Text',
        'closeclient_newsletter_title' => 'Newsletter: Title',
        'closeclient_newsletter_text' => 'Newsletter: Description',
        'closeclient_newsletter_button' => 'Newsletter: Button Text',
        'closeclient_about_button_text' => 'About: Button Text',
        'closeclient_about_headline_home' => 'About Home: Headline',
        'closeclient_about_tag_home' => 'About Home: Tag',
        'closeclient_authority_tag' => 'Authority Section: Tag',
        'closeclient_blog_sidebar' => 'Blog: Enable Sidebar',
        'closeclient_hero_image' => 'Hero: Image Overlay',
        'closeclient_label_archive' => 'Archive: Title Label',
        'closeclient_label_portfolio_single' => 'Portfolio: Single Label',
        'closeclient_label_search_query' => 'Search: Query Results Label',
        'closeclient_label_service_single' => 'Service: Single Label',
        'closeclient_lm_benefits' => 'Lead Magnet: Benefits (Comma Sep)',
        'closeclient_lm_button' => 'Lead Magnet: Button Text',
        'closeclient_lm_headline' => 'Lead Magnet: Headline',
        'closeclient_lm_image' => 'Lead Magnet: Image',
        'closeclient_lm_subheadline' => 'Lead Magnet: Subheadline',
        'closeclient_lm_tag' => 'Lead Magnet: Tag',
        'closeclient_portfolio_headline' => 'Portfolio: Headline',
        'closeclient_portfolio_tag' => 'Portfolio: Tag',
        'closeclient_sales_hero_headline_tpl' => 'Sales Hero: Headline',
        'closeclient_sales_hero_subheadline_tpl' => 'Sales Hero: Subheadline',
        'closeclient_sales_value_stack' => 'Sales Page: Value Stack (Comma Sep)',
        'closeclient_services_hero_headline_tpl' => 'Services Hero: Headline',
        'closeclient_services_subheadline_tpl' => 'Services Hero: Subheadline',
        'closeclient_site_layout_type' => 'Site Layout Type (Full/Boxed)',
        'closeclient_sticky_cta_button' => 'Sticky CTA: Button Text',
